...
import { Activity, AlertCircle, CheckCircle, RotateCw } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-lg border border-gray-700 bg-gray-800 p-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-medium text-gray-400">自动检查</h3>
              <div className="flex h-5 w-10 items-center rounded-full bg-success-700 px-1">
                <div className="h-3 w-3 rounded-full bg-white"></div>
              </div>
            </div>
            <p className="mt-2 text-2xl font-semibold">已启用</p>
            <p className="mt-2 text-sm text-gray-400">
              每 30 秒自动检查一次系统状态
            </p>
          </div>
